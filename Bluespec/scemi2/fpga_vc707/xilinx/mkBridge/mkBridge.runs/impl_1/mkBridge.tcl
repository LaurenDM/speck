...
set rc [catch {
  ...
  add_files -quiet /afs/athena.mit.edu/user/l/d/ldemeyer/6.375/ldemeyer/riscv-lab6b/scemi/fpga_vc707/xilinx/mkBridge/mkBridge.runs/synth_1/mkBridge.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache /afs/athena.mit.edu/user/l/d/ldemeyer/6.375/ldemeyer/riscv-lab6b/scemi/fpga_vc707/xilinx/mkBridge/mkBridge.cache}
  opt_design 
