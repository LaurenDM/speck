...
MOD_mkDutWrapper::MOD_mkDutWrapper(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_fromSyncQ(simHdl, "fromSyncQ", this, 1u, 2u, 0u),
    ...
    INST_tpDec(simHdl, "tpDec", this),
    INST_tpEnc(simHdl, "tpEnc", this),
    PORT_rst_usr$OUT_RST((tUInt8)1u),
    PORT_RST_N((tUInt8)1u),
    DEF_toKeySyncQ_first____d3(97u),
    DEF_toKeySyncQ_first_BITS_96_TO_1___d10(96u)
{
...
void MOD_mkDutWrapper::init_symbols_0()
{
  ...
  init_symbol(&symbols[2u], "CAN_FIRE_RL_putKey", SYM_DEF, &DEF_CAN_FIRE_RL_putKey, 1u);
  init_symbol(&symbols[3u], "CAN_FIRE_setkey_put", SYM_DEF, &DEF_CAN_FIRE_setkey_put, 1u);
  init_symbol(&symbols[4u], "dut_request_put", SYM_PORT, &PORT_dut_request_put, 1u);
  init_symbol(&symbols[5u], "dut_response_get", SYM_PORT, &PORT_dut_response_get, 1u);
  init_symbol(&symbols[6u], "EN_dut_request_put", SYM_PORT, &PORT_EN_dut_request_put, 1u);
  init_symbol(&symbols[7u], "EN_dut_response_get", SYM_PORT, &PORT_EN_dut_response_get, 1u);
  init_symbol(&symbols[8u], "EN_setkey_put", SYM_PORT, &PORT_EN_setkey_put, 1u);
  init_symbol(&symbols[9u], "fromSyncQ", SYM_MODULE, &INST_fromSyncQ);
  init_symbol(&symbols[10u], "RDY_dut_request_put", SYM_PORT, &PORT_RDY_dut_request_put, 1u);
  init_symbol(&symbols[11u], "RDY_dut_response_get", SYM_PORT, &PORT_RDY_dut_response_get, 1u);
  init_symbol(&symbols[12u], "RDY_setkey_put", SYM_PORT, &PORT_RDY_setkey_put, 1u);
  init_symbol(&symbols[13u], "RL_putKey", SYM_RULE);
  init_symbol(&symbols[14u], "rst_usr", SYM_MODULE, &INST_rst_usr);
  init_symbol(&symbols[15u], "setkey_put", SYM_PORT, &PORT_setkey_put, 97u);
  init_symbol(&symbols[16u], "toKeySyncQ", SYM_MODULE, &INST_toKeySyncQ);
  init_symbol(&symbols[17u], "toSyncQ", SYM_MODULE, &INST_toSyncQ);
  init_symbol(&symbols[18u], "tpDec", SYM_MODULE, &INST_tpDec);
  init_symbol(&symbols[19u], "tpEnc", SYM_MODULE, &INST_tpEnc);
  ...
  init_symbol(&symbols[21u],
	      ...
	      1u);
  init_symbol(&symbols[22u], "WILL_FIRE_RL_putKey", SYM_DEF, &DEF_WILL_FIRE_RL_putKey, 1u);
  init_symbol(&symbols[23u], "WILL_FIRE_setkey_put", SYM_DEF, &DEF_WILL_FIRE_setkey_put, 1u);
}
...
{
  tUInt8 DEF_NOT_toKeySyncQ_first_BIT_0___d11;
  DEF_toKeySyncQ_first____d3 = INST_toKeySyncQ.METH_first();
  wop_primExtractWide(96u,
		      97u,
		      DEF_toKeySyncQ_first____d3,
		      32u,
		      96u,
		      32u,
		      1u,
		      DEF_toKeySyncQ_first_BITS_96_TO_1___d10);
  DEF_toKeySyncQ_first_BIT_0___d4 = DEF_toKeySyncQ_first____d3.get_bits_in_word8(0u, 0u, 1u);
  DEF_NOT_toKeySyncQ_first_BIT_0___d11 = !DEF_toKeySyncQ_first_BIT_0___d4;
  INST_toKeySyncQ.METH_deq();
  if (DEF_toKeySyncQ_first_BIT_0___d4)
    INST_tpDec.METH_setKey(DEF_toKeySyncQ_first_BITS_96_TO_1___d10);
  if (DEF_NOT_toKeySyncQ_first_BIT_0___d11)
    INST_tpEnc.METH_setKey(DEF_toKeySyncQ_first_BITS_96_TO_1___d10);
}
...
tUInt8 MOD_mkDutWrapper::METH_dut_response_get()
{
  tUInt8 DEF_dut_response_get__avValue1;
...
void MOD_mkDutWrapper::reset_rst_usr$OUT_RST(tUInt8 ARG_rst_in)
{
  ...
  INST_tpEnc.reset_RST_N(ARG_rst_in);
  INST_tpDec.reset_RST_N(ARG_rst_in);
...
void MOD_mkDutWrapper::dump_state(unsigned int indent)
{
  ...
  INST_tpDec.dump_state(indent + 2u);
  INST_tpEnc.dump_state(indent + 2u);
}
...
unsigned int MOD_mkDutWrapper::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_1);
  vcd_write_def(sim_hdl, num++, "toKeySyncQ_first_BITS_96_TO_1___d10", 96u);
  vcd_set_clock(sim_hdl, num, __clk_handle_1);
  vcd_write_def(sim_hdl, num++, "toKeySyncQ_first_BIT_0___d4", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_1);
  vcd_write_def(sim_hdl, num++, "toKeySyncQ_first____d3", 97u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "dut_response_get", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  if (levels != 1u)
  {
    ...
    num = INST_tpDec.dump_VCD_defs(l);
    num = INST_tpEnc.dump_VCD_defs(l);
  }
...
void MOD_mkDutWrapper::vcd_defs(tVCDDumpType dt, MOD_mkDutWrapper &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_rst_usr$OUT_RST = PORT_rst_usr$OUT_RST;
      ...
      ++num;
      if ((backing.DEF_toKeySyncQ_first_BITS_96_TO_1___d10) != DEF_toKeySyncQ_first_BITS_96_TO_1___d10)
      {
	vcd_write_val(sim_hdl, num, DEF_toKeySyncQ_first_BITS_96_TO_1___d10, 96u);
	backing.DEF_toKeySyncQ_first_BITS_96_TO_1___d10 = DEF_toKeySyncQ_first_BITS_96_TO_1___d10;
      }
      ++num;
      if ((backing.DEF_toKeySyncQ_first_BIT_0___d4) != DEF_toKeySyncQ_first_BIT_0___d4)
      {
	vcd_write_val(sim_hdl, num, DEF_toKeySyncQ_first_BIT_0___d4, 1u);
	backing.DEF_toKeySyncQ_first_BIT_0___d4 = DEF_toKeySyncQ_first_BIT_0___d4;
      }
      ++num;
      if ((backing.DEF_toKeySyncQ_first____d3) != DEF_toKeySyncQ_first____d3)
      {
	vcd_write_val(sim_hdl, num, DEF_toKeySyncQ_first____d3, 97u);
	backing.DEF_toKeySyncQ_first____d3 = DEF_toKeySyncQ_first____d3;
      }
      ++num;
	...
	backing.PORT_dut_request_put = PORT_dut_request_put;
      ...
      {
	vcd_write_val(sim_hdl, num, PORT_dut_response_get, 1u);
...
{
  INST_tpDec.dump_VCD(dt, levels, backing.INST_tpDec);
  INST_tpEnc.dump_VCD(dt, levels, backing.INST_tpEnc);
}
