...
void MOD_mkDutWrapper::init_symbols_0()
{
  ...
  init_symbol(&symbols[6u], "dut_response_get", SYM_PORT, &PORT_dut_response_get, 1u);
  ...
  init_symbol(&symbols[17u], "setkey_put", SYM_PORT, &PORT_setkey_put, 97u);
  init_symbol(&symbols[18u], "toKeySyncQ", SYM_MODULE, &INST_toKeySyncQ);
  init_symbol(&symbols[19u], "toSyncQ", SYM_MODULE, &INST_toSyncQ);
  init_symbol(&symbols[20u], "tpDec", SYM_MODULE, &INST_tpDec);
  init_symbol(&symbols[21u], "tpEnc", SYM_MODULE, &INST_tpEnc);
  ...
  init_symbol(&symbols[23u],
	      ...
	      1u);
  init_symbol(&symbols[24u], "WILL_FIRE_RL_getResponse", SYM_DEF, &DEF_WILL_FIRE_RL_getResponse, 1u);
  init_symbol(&symbols[25u], "WILL_FIRE_RL_putKey", SYM_DEF, &DEF_WILL_FIRE_RL_putKey, 1u);
  init_symbol(&symbols[26u], "WILL_FIRE_setkey_put", SYM_DEF, &DEF_WILL_FIRE_setkey_put, 1u);
}
...
{
  tUInt8 DEF_tpEnc_ready_3_OR_tpDec_ready_4___d15;
  tUInt8 DEF_AVMeth_tpEnc_ready;
  tUInt8 DEF_AVMeth_tpDec_ready;
  DEF_AVMeth_tpEnc_ready = INST_tpEnc.METH_ready();
  DEF_AVMeth_tpDec_ready = INST_tpDec.METH_ready();
  DEF_tpEnc_ready_3_OR_tpDec_ready_4___d15 = DEF_AVMeth_tpEnc_ready || DEF_AVMeth_tpDec_ready;
  if (DEF_tpEnc_ready_3_OR_tpDec_ready_4___d15)
    INST_fromSyncQ.METH_enq((tUInt8)1u);
}
