...
#include "bs_vcd.h"
#include "mkThroughputDecrypt.h"
#include "mkThroughputEncrypt.h"
...
class MOD_mkDutWrapper : public Module {
 ...
 /* Module state */
 public:
  MOD_SyncFIFO<tUInt8,tUInt8> INST_fromSyncQ;
  MOD_SyncReset INST_rst_usr;
  MOD_SyncFIFO<tUWide,tUInt8> INST_toKeySyncQ;
  MOD_SyncFIFO<tUInt8,tUInt8> INST_toSyncQ;
  MOD_mkThroughputDecrypt INST_tpDec;
  MOD_mkThroughputEncrypt INST_tpEnc;
 ...
 public:
  ...
  tUInt8 PORT_dut_request_put;
  tUWide PORT_setkey_put;
  tUInt8 PORT_RDY_dut_request_put;
  tUInt8 PORT_dut_response_get;
 ...
 public:
  ...
  tUWide DEF_toKeySyncQ_first____d3;
  tUInt8 DEF_toKeySyncQ_first_BIT_0___d4;
 
 /* Local definitions */
 private:
  tUWide DEF_toKeySyncQ_first_BITS_96_TO_1___d10;
 ...
 /* Methods */
 public:
  void METH_dut_request_put(tUInt8 ARG_dut_request_put);
  tUInt8 METH_RDY_dut_request_put();
  tUInt8 METH_dut_response_get();
