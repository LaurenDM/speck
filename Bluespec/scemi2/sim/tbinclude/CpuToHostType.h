...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  ProcTypes::CpuToHostType
// Generated on: Sat Mar 12 13:30:00 EST 2016
...
/// C++ class representing the hardware enum ProcTypes::CpuToHostType.
/// This class has been automatically generated.
class CpuToHostType : public BSVType {
 public:

  enum E_CpuToHostType {
      e_ExitCode,
      e_PrintChar,
      e_PrintIntLow,
      e_PrintIntHigh
  ...
  E_CpuToHostType m_val;

  /// Default constructor for enumeration
  CpuToHostType (E_CpuToHostType v = e_ExitCode)
  : m_val(v)
  {}
  ...
  CpuToHostType (const SceMiMessageDataInterface *msg, unsigned int & off) {
    m_val = (E_CpuToHostType) msg->GetBitRange ( off, 1 );
    off = off + 2;
  }
  ...
  bool operator== (const E_CpuToHostType &x) const { return m_val == x ;}
  /// overload operator != for enumeration classes with values
  bool operator!= (const E_CpuToHostType &x) const { return m_val != x ;}
  /// overload operator == for enumeration classes
  bool operator== (const CpuToHostType &x) const { return m_val == x.m_val ;}
  /// overload operator != for enumeration classes
  bool operator!= (const CpuToHostType &x) const { return m_val != x.m_val ;}
  

  /// overload the put-to operator for CpuToHostType
  friend std::ostream & operator<< (std::ostream &os, const CpuToHostType & e) {
    BSVType::PutTo * override = lookupPutToOverride ( e.getClassName() );
    if ( override != 0 ) {
       return override(os, e );
    }
    switch (e.m_val) {
      case e_ExitCode: os << "ExitCode" ; break ;
      case e_PrintChar: os << "PrintChar" ; break ;
      case e_PrintIntLow: os << "PrintIntLow" ; break ;
      case e_PrintIntHigh: os << "PrintIntHigh" ; break ;
      default: os << "Enum value error for CpuToHostType: " << (int) e.m_val << "." ;
    }
    return os;
  };
  ...
  const char * getName() const {
    const char *ret = "" ;
    switch (m_val) {
      case e_ExitCode: ret = "ExitCode" ; break ;
      case e_PrintChar: ret = "PrintChar" ; break ;
      case e_PrintIntLow: ret = "PrintIntLow" ; break ;
      case e_PrintIntHigh: ret = "PrintIntHigh" ; break ;
      default: std::cerr << "Enum value error for CpuToHostType: " << (int) m_val << "." ;
    }
    return ret;
  };
