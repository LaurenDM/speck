...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  MemTypes::WideMemInitLoad
...
/// C++ class representing the hardware structure MemTypes::WideMemInitLoad
/// This class has been automatically generated.
class WideMemInitLoad : public BSVType {
 public:
  BitT<512> m_data ;
  BitT<24> m_addr ;
  ...
  WideMemInitLoad ( const SceMiMessageDataInterface *msg, unsigned int &off )
    : m_data(msg, off)
    , m_addr(msg, off)
  {}
  ...
  unsigned int setMessageData (SceMiMessageDataInterface &msg, const unsigned int off=0) const {
    ...
    if (running != off + 536 ) {
      std::cerr << "Mismatch in sizes: " << std::dec <<  running << " vs " << (off + 536) << std::endl;
    }
    return running;
  }

  /// overload the put-to operator for WideMemInitLoad
  friend std::ostream & operator<< (std::ostream &os, const WideMemInitLoad &obj) {
  ...
  virtual BSVType * getMember (unsigned int idx) {
    switch (idx) {
      ...
      default: std::cerr << "Index error in getMember for class WideMemInitLoad" << std::endl ;
    };
    return 0;
  };
  ...
  virtual const char * getMemberName (unsigned int idx) const {
    switch (idx) {
      case 0: return "addr";
      case 1: return "data";
      default: std::cerr << "Index error in getMemberName for class WideMemInitLoad" << std::endl ;
    };
    return 0;
  };
