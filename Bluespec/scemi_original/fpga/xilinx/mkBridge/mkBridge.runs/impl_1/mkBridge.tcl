...
set rc [catch {
  ...
  add_files -quiet /mnt/nfs/var/nfs/ldemeyer/speck/Bluespec/scemi_original/fpga/xilinx/mkBridge/mkBridge.runs/synth_1/mkBridge.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache /mnt/nfs/var/nfs/ldemeyer/speck/Bluespec/scemi_original/fpga/xilinx/mkBridge/mkBridge.cache}
  opt_design 
