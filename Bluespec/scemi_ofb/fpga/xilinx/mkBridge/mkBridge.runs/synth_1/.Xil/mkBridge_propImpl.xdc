set_property SRC_FILE_INFO {cfile:/mnt/nfs/var/nfs/ldemeyer/speck/Bluespec/scemi_ofb/fpga/xilinx/default.xdc rfile:../../../../default.xdc id:1} [current_design]
...
set_max_delay 4.0 -datapath_only -from [get_clocks cclock] -to [get_clocks my_clk_usr]
