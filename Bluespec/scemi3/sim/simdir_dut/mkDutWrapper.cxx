...
void MOD_mkDutWrapper::init_symbols_0()
{
  ...
  init_symbol(&symbols[8u], "dut_request_put", SYM_PORT, &PORT_dut_request_put, 49u);
  init_symbol(&symbols[9u], "dut_response_get", SYM_PORT, &PORT_dut_response_get, 49u);
  init_symbol(&symbols[10u], "EN_dut_request_put", SYM_PORT, &PORT_EN_dut_request_put, 1u);
  init_symbol(&symbols[11u], "EN_dut_response_get", SYM_PORT, &PORT_EN_dut_response_get, 1u);
  init_symbol(&symbols[12u], "EN_setkey_put", SYM_PORT, &PORT_EN_setkey_put, 1u);
  init_symbol(&symbols[13u], "encrypt", SYM_MODULE, &INST_encrypt);
  init_symbol(&symbols[14u], "fromSyncQ", SYM_MODULE, &INST_fromSyncQ);
  init_symbol(&symbols[15u], "RDY_dut_request_put", SYM_PORT, &PORT_RDY_dut_request_put, 1u);
  init_symbol(&symbols[16u], "RDY_dut_response_get", SYM_PORT, &PORT_RDY_dut_response_get, 1u);
  init_symbol(&symbols[17u], "RDY_setkey_put", SYM_PORT, &PORT_RDY_setkey_put, 1u);
  init_symbol(&symbols[18u], "RL_enqRequest", SYM_RULE);
  init_symbol(&symbols[19u], "RL_getResponseDecrypt", SYM_RULE);
  init_symbol(&symbols[20u], "RL_getResponseEncrypt", SYM_RULE);
  init_symbol(&symbols[21u], "RL_putKey", SYM_RULE);
  init_symbol(&symbols[22u], "rst_usr", SYM_MODULE, &INST_rst_usr);
  init_symbol(&symbols[23u], "setkey_put", SYM_PORT, &PORT_setkey_put, 97u);
  init_symbol(&symbols[24u], "toKeySyncQ", SYM_MODULE, &INST_toKeySyncQ);
  init_symbol(&symbols[25u], "toSyncQ", SYM_MODULE, &INST_toSyncQ);
  ...
  init_symbol(&symbols[27u],
	      ...
	      1u);
  init_symbol(&symbols[28u], "WILL_FIRE_RL_enqRequest", SYM_DEF, &DEF_WILL_FIRE_RL_enqRequest, 1u);
  ...
  init_symbol(&symbols[30u],
	      ...
	      1u);
  init_symbol(&symbols[31u], "WILL_FIRE_RL_putKey", SYM_DEF, &DEF_WILL_FIRE_RL_putKey, 1u);
  init_symbol(&symbols[32u], "WILL_FIRE_setkey_put", SYM_DEF, &DEF_WILL_FIRE_setkey_put, 1u);
}
