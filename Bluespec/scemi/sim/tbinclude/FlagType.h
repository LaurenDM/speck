...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  SceMiLayer::FlagType
...
/// C++ class representing the hardware enum SceMiLayer::FlagType.
