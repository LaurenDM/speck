...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  FixedPoint::FixedPoint#(16,16)
...
/// C++ class representing the hardware structure FixedPoint::FixedPoint#(16,16)
/// This class has been automatically generated.
class FixedPoint_16_16 : public BSVType {
 public:
  BitT<16> m_f ;
  BitT<16> m_i ;
  ...
  FixedPoint_16_16 ( const SceMiMessageDataInterface *msg, unsigned int &off )
    : m_f(msg, off)
    , m_i(msg, off)
  {}
  ...
  unsigned int setMessageData (SceMiMessageDataInterface &msg, const unsigned int off=0) const {
    ...
    running = m_f.setMessageData( msg, running );
    running = m_i.setMessageData( msg, running );
    if (running != off + 32 ) {
  ...
  /// overload the put-to operator for FixedPoint_16_16
  friend std::ostream & operator<< (std::ostream &os, const FixedPoint_16_16 &obj) {
  ...
  virtual std::ostream & getBSVType (std::ostream & os) const {
    os << "FixedPoint::FixedPoint#(16,16)" ;
    return os;
  }
  ...
  virtual BSVType * getMember (unsigned int idx) {
    switch (idx) {
      case 0: return & m_i;
      case 1: return & m_f;
      default: std::cerr << "Index error in getMember for class FixedPoint_16_16" << std::endl ;
    };
    return 0;
  };
  ...
  virtual const char * getMemberName (unsigned int idx) const {
    switch (idx) {
      case 0: return "i";
      case 1: return "f";
      default: std::cerr << "Index error in getMemberName for class FixedPoint_16_16" << std::endl ;
    };
    return 0;
  };
