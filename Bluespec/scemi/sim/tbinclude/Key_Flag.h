...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  SceMiLayer::Key_Flag
...
/// C++ class representing the hardware structure SceMiLayer::Key_Flag
